...
export default function Portfolio() {
    ...
    return (
        <section id="portfolio" className="section bg-bg-secondary">
                ...
                <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 list-none">
                    {filtered.map((project) => (
                        ...
                        >
                            ...
                            <div className="relative w-full h-44 overflow-hidden bg-bg-card-hover">
                            ...
                            {/* Color bar */}
                            <div className="portfolio-card__bar h-0.75" aria-hidden="true" />
